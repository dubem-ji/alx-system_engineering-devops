...
[6-firstdirectory](./6-firstdirectory) - Create a script that creates a directory named school in the /tmp/ directory.

[7-movethatfile](./7-movethatfile) - Move the file betty from /tmp/ to /tmp/school.

[8-firstdelete](./8-firstdelete) - Delete the file betty. The file betty is in /tmp/school

[9-firstdirdeletion](./9-firstdirdeletion) - Delete the directory school that is in the /tmp directory.
