...
[17-Star_Wars](./17-Star_Wars) - Write a script that will play the StarWars IV episode in the terminal.

[18-man_holberton](./18-man_holberton) - Create a man that looks exactly like this one and passes all checks.
